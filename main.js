(function() {
    ...
    if (typeof Typed !== 'undefined') {
        ...
        console.error('Typed is not defined');
    }
    ...
    window.addEventListener('load', () => {
        let portfolioContainers = document.querySelectorAll('.portfolio-container');
        portfolioContainers.forEach((portfolioContainer, index) => {
            let portfolioIsotope = new Isotope(portfolioContainer, {
                itemSelector: '.portfolio-item'
            });

            let portfolioFilters = document.querySelectorAll(`#portfolio-flters-${index + 1} li`);
        ...
        // Ensure GLightbox is defined before using it
